...
![Trainer mounted on a cage](assets/cage/trainer-on-cage.jpg)

The trainer uses **two hooks** near the top and **two clamps** near the bottom. Clamps adjust for different cages (TODO: hook-adjustment diagram). Use an **8 mm** or **3/16"** wrench on the jam nut: loosen, set hook reach, then tighten.
...
4. Let the trainer settle, then clamp the hooks in place.  
