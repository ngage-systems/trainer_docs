...
| Topic | Description |
|--------|-------------|
| [Get to know your device](docs/device-overview.md) | Front/back layout and labeled parts (diagrams TODO). |
| [Basic operation](docs/basic-operation.md) | Power, bottle setup, tasks, cleanup, charging. |
